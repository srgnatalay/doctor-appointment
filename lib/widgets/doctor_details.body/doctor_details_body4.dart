...
class DetailBody4 extends StatefulWidget {
  const DetailBody4({super.key});

  @override
  State<DetailBody4> createState() => _DetailBody4State();
}

class _DetailBody4State extends State<DetailBody4> {
...
class _DoctorInfoState extends State<DoctorInfo> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        InfoCard(
            label: "Deneyim", value: "${doctorDataList[3].experience!} yıl"),
      ],
    );
  }
}
