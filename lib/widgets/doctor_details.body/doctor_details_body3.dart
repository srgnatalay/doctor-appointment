...
class DetailBody3 extends StatefulWidget {
  const DetailBody3({super.key});

  @override
  State<DetailBody3> createState() => _DetailBody3State();
}

class _DetailBody3State extends State<DetailBody3> {
...
class _DoctorInfoState extends State<DoctorInfo> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        InfoCard(
            label: "Deneyim", value: "${doctorDataList[2].experience!} yıl"),
      ],
    );
  }
}
