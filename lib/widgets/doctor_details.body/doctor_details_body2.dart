...
class DetailBody2 extends StatefulWidget {
  const DetailBody2({super.key});

  @override
  State<DetailBody2> createState() => _DetailBody2State();
}

class _DetailBody2State extends State<DetailBody2> {
...
class _DoctorInfoState extends State<DoctorInfo> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        InfoCard(
            label: "Deneyim", value: "${doctorDataList[1].experience!} yıl"),
      ],
    );
  }
}
